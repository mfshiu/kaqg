...
class ConceptScorer:
    ...
    def get_concepts_average_score_and_sort(self, concept_names, alpha=0.5, a=1, b=1, c=1):
        ...
        for i, s in enumerate(all_scores):
            ...
            # 隨機調整分數
            avg_score = avg_score + (avg_score * random.uniform(-0.5, 0.5))
            results.append({
...
if __name__ == "__main__":
    ...
    with ConceptScorer(uri,username,password) as scorer:
        ...
        sorted_results = scorer.get_concepts_average_score_and_sort(concepts, alpha=0.3, a=1, b=1, c=1)
        print("加權綜合分數排序：")
